...
<link rel="icon" type="image/png" href="../images/ea_logo.png">
...
<style type="text/css">
    :root{
        ...
        --pine-green: #0b7a75ff;
        --dutch-white: #d7c9aaff;
        --persian-plum: #7b2d26ff;
        --cultured: #f0f3f5ff;

        /* CSS HSL */
        --midnight-green-eagle-green: hsla(190, 58%, 24%, 1);
        --pine-green: hsla(177, 83%, 26%, 1);
        --dutch-white: hsla(41, 36%, 75%, 1);
        --persian-plum: hsla(5, 53%, 32%, 1);
        ...
        /* SCSS RGB */
        $midnight-green-eagle-green: rgba(25, 83, 95, 1);
        $pine-green: rgba(11, 122, 117, 1);
        $dutch-white: rgba(215, 201, 170, 1);
        $persian-plum: rgba(123, 45, 38, 1);
        ...
        $gradient-radial: radial-gradient(#19535fff, #0b7a75ff, #d7c9aaff, #7b2d26ff, #f0f3f5ff);
    }

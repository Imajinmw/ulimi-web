...
function Welcome(){
    const [stage, setStage] = useState("questions"); //home
                    ...
                    <div className="w3-col m2 w3-border-right" style={{height:window.innerHeight+"px", overflowY:"auto", borderColor:"var(--success)", background:"var(--u-dark)"}}>
                        <div className="w3-padding">
                            <div className="w3-center pt-15 pb-15">
                                <img src="../images/seedling.svg" width={"40%"} />
                                <br /><br />
                                <font className="block">{user.name}</font>
                                <font className="block text-success">{"[admin]"}</font>
                            </div>
                            {menus.map(menu=>(
...
function Practices(){
    const [value, setValue] = React.useState(0);
    const [where,setWhere] = useState("tables");
    ...
    const getRows = () => {
        $.get("api/", {getCropAnimals:"true"}, function(res){
            setRows(res);
        })
    }
    ...
    return (
        <Context.Provider value={{active,setActive,where,setWhere}}>
            {where == "tables" ? <>
                <div className="w3-padding bg-alert">
                    Manage Crop and Animal Husbandry Practices
                </div>

                <Box sx={{ width: '100%', typography: 'body1' }}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <Tabs value={value} onChange={handleChange} aria-label="lab API tabs example">
                            <Tab label="Animals" {...a11yProps(0)} style={{textTransform:"none"}} />
                            <Tab label="Crops" {...a11yProps(1)} style={{textTransform:"none"}} />
                        </Tabs>
                    </Box>
                    <TabPanel value={value} index={0}>
                        <div className="w3-row">
                            <div className="w3-col m8 w3-padding">
                                <Table>
                                    ...
                                    <TableBody>
                                        {rows.filter(r=>(r.type == "animal")).map((row,index)=>(
                                            <TableRow hover key={index}>
                                                ...
                                                <TableCell style={{padding:"4px"}}>
                                                    <Button variant="contained" color="error" size="small" style={{textTransform:"none"}} onClick={e=>{
                                                        setActive(row);
                                                        setWhere("details");
                                                    }}>Manage</Button>
                                                </TableCell>
                            ...
                            <div className="w3-col m4 w3-padding">
                                <Typography component="h4">Add new Animal</Typography>
                                {errors.animal?<Alert severity="error" sx={{mt:1,mb:1}}>{errors.animal}</Alert>:""}
                                <form onSubmit={saveQuestion}>
                                    <input type="hidden" name="type" value={"animal"} />
                                    <TextField fullWidth sx={{mt:2}} size="small" label="Name" name="husbandry_name" /> 
                                    <TextField fullWidth label="Descriptions" sx={{mt:2}} size="small" multiline rows={3} name="description" />
                                    
                                    <TextField fullWidth sx={{mt:2,mb:3}} type="file" accept="image/*" size="small" label="Picture" name="picture" required="required" /> 

                                    <Button type="submit" variant="contained">Save Animal</Button>
                                </form>
                            </div>
                        </div>
                    </TabPanel>
                        ...
                        <div className="w3-row">
                            <div className="w3-col m8 w3-padding">
                                <Table>
                                    ...
                                    <TableBody>
                                        {rows.filter(r=>(r.type == "crop")).map((row,index)=>(
                                            <TableRow hover key={index}>
                                                <TableCell padding="none">{index+1}</TableCell>
                                                <TableCell padding="none">{row.name}</TableCell>
                                                <TableCell padding="none">{row.picture}</TableCell>
                                                ...
                                                <TableCell style={{padding:"4px"}}>
                                                    <Button variant="contained" color="error" size="small" onClick={e=>{
                                                        setActive(row);
                                                        setWhere("details");
                                                    }} style={{textTransform:"none"}}>Manage</Button>
                                                </TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                            ...
                            <div className="w3-col m4 w3-padding">
                                <Typography component="h4">Add new Crop</Typography>
                                {errors.crop?<Alert severity="error" sx={{mt:1,mb:1}}>{errors.crop}</Alert>:""}
                                <form onSubmit={saveQuestion}>
                                    ...
                                    <Button type="submit" variant="contained">Save Crop</Button>
                                </form>
                            </div>
                        </div>
                    </TabPanel>
            ...
            where == "details" ? <HusbandryDetails/>:
            <>{where}</>}
        </Context.Provider>
    )
}
                                    ...
                                    <TableBody>
                                        {days.slice(rowsPerPage.general*page.general, (page.general+1)*rowsPerPage.general).map((row,index)=>(
                                            <TableRow hover key={index}>
                                                ...
                                                <TableCell padding="none">{row.start}</TableCell>
                                                <TableCell padding="none">{row.end}</TableCell>
                                                <TableCell padding="none">{row.hours+"hrs"}</TableCell>
                                                <TableCell padding="7px">{row.overtime+"hrs"}</TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
...
function Warehouse(){
    ...
    return (
        <>
            <div className="w3-padding alert-warning">Manage Clubs</div>
            <Box sx={{ width: '100%', typography: 'body1' }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    <Tabs value={value} onChange={handleChange} aria-label="lab API tabs example">
                        <Tab label="Available Clubs" {...a11yProps(0)} style={{textTransform:"none"}} />
                        <Tab label="Districts" {...a11yProps(1)} style={{textTransform:"none"}} />
                    </Tabs>
                </Box>
                <TabPanel value={value} index={0}>
                    <div className="w3-padding">
                        <Button sx={{mt:1,mb:1}} variant="contained" onClick={e=>{setOpen(true)}} >Add Club</Button>
                    </div>
                    <div className="w3-padding">
                        <Paper sx={{ width: '100%'}}>
                            <TableContainer>
                ...
                <TabPanel value={value} index={1}>
                    <div className="w3-padding">
                        <Button sx={{mt:1,mb:1}} variant="contained" onClick={e=>{setAdd(true)}} >Add District</Button>
                    </div>
                    <div className="w3-padding">
                        <Paper sx={{ width: '100%'}}>
                            <TableContainer>
            ...
            <div className="w3-modal" style={{display:(open?"block":"none")}}>
                <div className="w3-modal-content shadow rounded w3-padding-large" style={{width:"400px"}}>
                    <font className="w3-large">Add new Club</font>
                    
                    {error.length > 0?<Alert severity="error">{error}</Alert>:""}

                    <form className="pt-30" onSubmit={saveWarehouse}>
                        <TextField select label="District" size="small" name="parent"  fullWidth>
                            {groups.map((option) => (
                        ...
                        <TextField fullWidth name="warehouse_name" sx={{mt:2}} label="Club Name" size="small"  />
...
function Farmers(){
    ...
    return (
        <>
            <div className="w3-padding alert-primary">Manage Farmers</div>
            <div className="w3-padding">
                <Button sx={{mt:1,mb:1}} variant="contained" onClick={e=>{setOpen(true)}}>Add Farmer</Button>
            </div>
            <div className="w3-padding">
                            ...
                            <TableBody>
                                {rows.map((row,index)=>(
                                    <TableRow hover key={index}>
                                        ...
                                        <TableCell padding="none">{row.district}</TableCell>
                                        <TableCell style={{padding:"5px"}}>
                ...
                <Paper>
                    <Table>
                        ...
                        <TableBody>
                            {rows.map((row,index)=>(
                                <TableRow hover>
                                    <TableCell padding="small">{index+1}</TableCell>
                                    <TableCell padding="small">{row.warehouse_data.name}</TableCell>
                                    <TableCell padding="small">{row.supervisor_data.name}</TableCell>
                                    <TableCell padding="small">{row.content}</TableCell>
                                    <TableCell padding="small">{row.date}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
...
function HusbandryDetails(){
    const {active,setActive,where,setWhere} = useContext(Context);
    const [value, setValue] = React.useState(0);
    ...
    const saveEnvironment = (event) => {
        ...
        post("api/", formdata, function(response){
            try{
                ...
                if(res.status){
                    //success
                    setOpen({...open, environment:false})
                    getEnvironment();
                }
                else{
                    Toast(res.message);
    ...
    const getEnvironment = () => {
        $.get("api/", {getEnvironment:active.id}, function(res){
            setEnvironment(res);
        })
    }

    const getActivities = () => {
        $.get("api/", {getActivities:active.id}, function(res){
            setActivities(res);
        })
    }
    ...
    const changePicture = (event) => {
        ...
        input.addEventListener("change", (event)=>{
            ...
            formdata.append("item", active.id);
    ...
    return (
        <>
            <div className="w3-padding-large" onClick={e=>setWhere("tables")}>
                <i className="fa fa-arrow-left"/> Go back
            </div>

            <Alert severity="info" sx={{m:2}}>Managing - <b>{active.name}</b></Alert>

            <div className="w3-row">
                <div className="w3-col m3 w3-padding w3-center">
                    <img src={"../uploads/"+active.picture} width={"80%"} />
                    <br />
                    <br />
                    <Button variant="outlined" sx={{textTransform:"none"}} onClick={changePicture} size="small">Change Picture</Button>
                </div>
                <div className="w3-col m9 w3-padding">
                    <Box sx={{ width: '100%', typography: 'body1' }}>
                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                            <Tabs value={value} onChange={handleChange} aria-label="lab API tabs example">
                                <Tab label="Environment" {...a11yProps(0)} style={{textTransform:"none"}} />
                                <Tab label="Activities" {...a11yProps(1)} style={{textTransform:"none"}} />
                                <Tab label="Diseases" {...a11yProps(2)} style={{textTransform:"none"}} />
                            </Tabs>
                        </Box>
                        <TabPanel value={value} index={0}>
                            <Chip avatar={<Avatar><i className="fa fa-plus-circle" /></Avatar>} onClick={e=>setOpen({...open, environment:true})} label="Add" />
                            <div className="pt-20">
                                {environment.map((row=>(
                                    <div className="mt-15 border rounded w3-padding">
                                        <font className="block bold">{row.title}</font>
                                        {row.picture.length > 3 ? <img src={"../uploads/"+row.picture} width="50%" />:""}
                                        <font className="block">{row.description}</font>
                                    </div>
                                )))}
                            </div>
                        </TabPanel>
                        <TabPanel value={value} index={1}>
                            <Chip avatar={<Avatar><i className="fa fa-plus-circle" /></Avatar>} onClick={e=>setOpen({...open, activity:true})} label="Add" />
                            <div className="pt-20">
                                {activities.map((row=>(
                                    <div className="mt-15 border rounded w3-padding">
                                        <font className="block bold">{row.title}</font>
                        ...
                        <TabPanel value={value} index={2}>
                            <Chip avatar={<Avatar><i className="fa fa-plus-circle" /></Avatar>} label="Add" />
                        </TabPanel>
                    </Box>
                </div>
            </div>

            {open.environment ? <div className="w3-modal" style={{display:"block"}}>
                <div className="w3-modal-content w3-padding-large w3-round-large">
                    <font className="w3-large">Add Environment Requirement</font>
                    <form onSubmit={saveEnvironment}>
                        <input type="hidden" name="item" value={active.id} />
                        <TextField label="Title" name="environment_title" sx={{mt:3}} fullWidth size="small" />
                        <TextField label="Description" name="description" multiline rows={5} sx={{mt:2}} fullWidth size="small" />
                        <TextField label="Picture" sx={{mt:2}} type="file" accept="image/*" name="picture" fullWidth size="small" />
                        <Button variant="contained" sx={{mt:3}} type="submit">Submit</Button>
                    </form>
                    <div className="pt-10 pb-10 clearfix">
                        <Button className="float-right" color="error" variant="contained" onClick={e=>{
                            setOpen({...open, environment:false});
                        }}>Close</Button>
                    </div>
                </div>
            ...
            {open.activity ? <div className="w3-modal" style={{display:"block"}}>
                <div className="w3-modal-content w3-padding-large w3-round-large">
                    <font className="w3-large">Add Activity</font>
                    <form onSubmit={saveActivity}>
                        <input type="hidden" name="item" value={active.id} />
                        <TextField label="Title" name="activity_title" sx={{mt:3}} fullWidth size="small" />
                        <TextField label="Description" name="description" multiline rows={5} sx={{mt:2}} fullWidth size="small" />
                        <TextField label="Picture" sx={{mt:2}} type="file" accept="image/*" name="picture" fullWidth size="small" />
                        <Button variant="contained" sx={{mt:3}} type="submit">Submit</Button>
                    </form>
